...
{
/**
 * \brief Tracker. Process each event to update estimated pose
...
{
    static double t_prev = -0.1; // time for the previous event among all pixel
    ...
    // Calculate points on current pose and previous pose
...
/**
 * \brief Fuction to calculate the 4 vertex of the tracking Polygon
 */
